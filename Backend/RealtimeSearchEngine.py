...
def RealtimeSearchEngine(prompt):
    ...
    SystemChatBot.append({"role": "system", "content":GoogleSearch(prompt)})  # ← complete this as needed with the correct logic
    ...
    completion=client.chat.completions.create(
        ...
        top_p=1,    # Adjust randomness (higher means more random).
