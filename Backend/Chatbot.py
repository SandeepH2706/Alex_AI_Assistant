...
def ChatBot(Query):
    ...
    # Append the user's query to the messages list.
        ...
        # Make a request to the OpenAI API for a response.
        completion = client.chat.completions.create(
            model="llama3-70b-8192",  # Specify the AI model to use.
            messages=SystemChatBot+[{"role": "system", "content": f"{RealtimeInformation()}"}]+messages, # Include system instructions, real-time info, and chat history.
            max_tokens=1024,    # Limit the maximum tokens in the response.
            temperature=0.7,    # Adjust randomness (higher means more random).
            top_p=1,
...
if __name__ == "__main__":
    while True:
        ...
        print(ChatBot(input("Enter Your Question: ")))  # Call the chatbot function and print its response.