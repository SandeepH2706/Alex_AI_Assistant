from PyQt5.QtWidgets import (QApplication, QMainWindow, QTextEdit, QStackedWidget, QWidget, QLineEdit, QGridLayout, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QFrame, QScrollBar,QSizePolicy)
from PyQt5.QtGui import (QIcon, QMovie, QColor, QTextCharFormat, QFont, QPixmap, QTextBlockFormat, QTextCursor,QPainter)
...
class ChatSection(QWidget):
    ...
    def __init__(self):
        ...
        # Set text color using char format
        ...
        movie = QMovie(GraphicDirectoryPath("Alex.gif"))
        max_gif_size_W = 480
        max_gif_size_H = 270
        movie.setScaledSize(QSize(max_gif_size_W,max_gif_size_H))
        self.gif_label.setAlignment(Qt.AlignBottom | Qt.AlignRight)  # Fixed alignment
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        title_label = QLabel(f"{str(Assistantname).capitalize()} AI     ")#hedding
